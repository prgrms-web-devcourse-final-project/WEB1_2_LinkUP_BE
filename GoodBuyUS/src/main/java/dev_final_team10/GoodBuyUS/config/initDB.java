...
public class initDB {
    ...
    public void createProduct(){
        Product fruit1 = Product.createProduct("싱싱한 사과", 5000, "https://cdn.pixabay.com/photo/2023/08/25/10/33/apples-8212695_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_FRUITS,3);
        Product fruit2 = Product.createProduct("달콤한 바나나", 4000, "https://cdn.pixabay.com/photo/2015/02/27/17/58/bananas-652497_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_FRUITS,100);
        Product fruit3 = Product.createProduct("신선한 포도", 6000, "https://cdn.pixabay.com/photo/2023/10/10/16/05/grapes-8306833_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_FRUITS,100);
        Product vegetable1 = Product.createProduct("유기농 당근", 3000, "https://cdn.pixabay.com/photo/2018/05/29/23/23/carrots-3440368_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_VEGETABLES,100);
        Product vegetable2 = Product.createProduct("싱싱한 오이", 2500, "https://cdn.pixabay.com/photo/2015/03/23/08/04/cucumber-685704_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_VEGETABLES,100);
        Product vegetable3 = Product.createProduct("신선한 양파", 2000, "https://cdn.pixabay.com/photo/2016/03/05/19/14/onions-1238332_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_VEGETABLES,100);
        Product meat1 = Product.createProduct("프리미엄 소고기", 20000, "https://cdn.pixabay.com/photo/2022/11/15/12/22/meat-7593865_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_MEAT,100);
        Product meat2 = Product.createProduct("신선한 돼지고기", 15000, "https://cdn.pixabay.com/photo/2018/02/08/15/01/meat-3139640_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_MEAT,100);
        Product meat3 = Product.createProduct("닭가슴살", 10000, "https://cdn.pixabay.com/photo/2020/02/02/15/07/meat-4813261_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_MEAT,100);
        Product seafood1 = Product.createProduct("싱싱한 연어", 18000, "https://cdn.pixabay.com/photo/2010/12/13/10/25/canape-2802_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_SEAFOOD,100);
        Product seafood2 = Product.createProduct("탱글한 새우", 15000, "https://cdn.pixabay.com/photo/2021/07/25/18/55/shrimp-6492587_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_SEAFOOD,100);
        Product seafood3 = Product.createProduct("고소한 오징어", 12000, "https://cdn.pixabay.com/photo/2017/09/11/08/50/ink-2738296_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_SEAFOOD,100);
        Product dairy1 = Product.createProduct("신선한 우유", 4000, "https://cdn.pixabay.com/photo/2017/07/05/15/41/milk-2474993_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_DAIRY,100);
        Product dairy2 = Product.createProduct("고소한 치즈", 8000, "https://cdn.pixabay.com/photo/2023/11/10/10/19/cheese-8379082_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_DAIRY,100);
        Product dairy3 = Product.createProduct("부드러운 요거트", 5000, "https://cdn.pixabay.com/photo/2020/04/23/12/20/strawberry-5082252_1280.jpg", ProductCategory.FOOD, SubCategory.FRESH_FOOD, DetailCategory.FRESH_FOOD_DAIRY,100);
        Product frozen1 = Product.createProduct("냉동 만두", 5000, "https://cdn.pixabay.com/photo/2023/12/15/05/31/food-8450082_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_FROZEN,100);
        Product frozen2 = Product.createProduct("냉동 피자", 8000, "https://cdn.pixabay.com/photo/2016/11/29/13/02/cheese-1869708_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_FROZEN,100);
        Product frozen3 = Product.createProduct("냉동 닭가슴살", 10000, "https://cdn.pixabay.com/photo/2021/10/22/05/45/duck-breast-6731150_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_FROZEN,100);
        Product snack1 = Product.createProduct("감자칩", 3000, "https://cdn.pixabay.com/photo/2017/08/14/14/56/crisp-2640743_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_SNACKS,100);
        Product snack2 = Product.createProduct("초콜릿 바", 2500, "https://cdn.pixabay.com/photo/2016/02/24/10/58/choco-1219557_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_SNACKS,100);
        Product snack3 = Product.createProduct("쿠키", 4000, "https://cdn.pixabay.com/photo/2015/05/07/15/08/cookie-756601_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_SNACKS,100);
        Product drink1 = Product.createProduct("콜라", 1500, "https://cdn.pixabay.com/photo/2014/09/26/19/51/drink-462776_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_DRINKS,100);
        Product drink2 = Product.createProduct("오렌지 주스", 2500, "https://cdn.pixabay.com/photo/2016/08/23/15/52/fresh-orange-juice-1614822_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_DRINKS,100);
        Product drink3 = Product.createProduct("커피 음료", 3000, "https://cdn.pixabay.com/photo/2019/11/25/06/21/coffee-4651087_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_DRINKS,100);
        Product canned1 = Product.createProduct("참치 통조림", 3500, "https://cdn.pixabay.com/photo/2023/06/09/13/42/canned-goods-8051752_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_CANNED,100);
        Product canned2 = Product.createProduct("옥수수 통조림", 2000, "https://cdn.pixabay.com/photo/2019/04/15/15/20/canning-4129548_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_CANNED,100);
        Product canned3 = Product.createProduct("콩 통조림", 2500, "https://cdn.pixabay.com/photo/2020/04/11/08/07/vegetarian-5029296_1280.jpg", ProductCategory.FOOD, SubCategory.PROCESSED_FOOD, DetailCategory.PROCESSED_FOOD_CANNED,100);
        Product vitamin1 = Product.createProduct("비타민C", 12000, "https://cdn.pixabay.com/photo/2012/04/10/17/40/vitamins-26622_1280.png", ProductCategory.FOOD, SubCategory.HEALTH_FOOD, DetailCategory.HEALTH_FOOD_VITAMINS,100);
        Product vitamin2 = Product.createProduct("비타민D", 15000, "https://cdn.pixabay.com/photo/2012/04/10/17/40/vitamins-26622_1280.png", ProductCategory.FOOD, SubCategory.HEALTH_FOOD, DetailCategory.HEALTH_FOOD_VITAMINS,100);
        Product vitamin3 = Product.createProduct("종합 비타민", 18000, "https://cdn.pixabay.com/photo/2012/04/10/17/40/vitamins-26622_1280.png", ProductCategory.FOOD, SubCategory.HEALTH_FOOD, DetailCategory.HEALTH_FOOD_VITAMINS,100);
